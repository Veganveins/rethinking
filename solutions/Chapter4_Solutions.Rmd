...
```{r}
alpha <- rnorm(n = 1000, mean = 178, sd = 20)
beta <- rlnorm(n = 1000, mean = 0, sd = 1)
#summary(log(d$weight))
weights <- seq(from = 1.4, to = 4.1, length.out = 1000)

sample_mu <- alpha + beta * weights
sample_sigma <- runif(n = 1000, min = 0, max = 50)
  
prior_h_poly <- rnorm(1e4, mean = sample_mu, sd = sample_sigma)
dens(prior_h_poly)
abline(h = 272)
```
...
```{r}
alpha <- rnorm(n = 1000, mean = 150, sd = 15) # maybe decrease the mean a bit (and sd)
beta <- rlnorm(n = 1000, mean = 0, sd = 1)
#summary(log(d$weight))
weights <- seq(from = 1.4, to = 4.1, length.out = 1000)

sample_mu <- alpha + beta * weights
sample_sigma <- runif(n = 1000, min = 0, max = 20) # shrinking sigma should do it?
  
prior_h_poly <- rnorm(1e3, mean = sample_mu, sd = sample_sigma)
#dens(prior_h_poly)

plot(weights, prior_h_poly)
abline(v = 272)
```